...
begin
   ...
   LRetorno  :=  'CEP:       31920160End:       Rua Três BicasBairro:    Dom JoaquimUF:        MGCidade:    Belo HorizonteLatitude:  -19.87972Longitude: '+
                 '-43.91421IBGE:      ';
...
begin
   ...
   LRetorno  :=  'Cep     : 31920-160Estado  : MGCidade  : Belo HorizonteBairro  : Dom JoaquimEnd     : Rua Três Bicas';
...
begin
   ...
   LRetorno  :=  'CEP:       31920-160End:       Rua Três BicasCompl:     Bairro:    Dom JoaquimCidade:    Belo HorizonteUF:        MGCod. IBGE: 3106200';
